...
class AssetNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Rapid7\\InsightVM\\Api\\Model\\Asset';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Rapid7\\InsightVM\\Api\\Model\\Asset';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Rapid7\InsightVM\Api\Model\Asset();
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $object->getServices()) {
            $values_6 = array();
            foreach ($object->getServices() as $value_6) {
                $values_6[] = $this->normalizer->normalize($value_6, 'json', $context);
            }
            $data['services'] = $values_6;
        }
        if (null !== $object->getSoftware()) {
            $values_7 = array();
            foreach ($object->getSoftware() as $value_7) {
                $values_7[] = $this->normalizer->normalize($value_7, 'json', $context);
            }
            $data['software'] = $values_7;
        }
        ...
        if (null !== $object->getUserGroups()) {
            $values_8 = array();
            foreach ($object->getUserGroups() as $value_8) {
                $values_8[] = $this->normalizer->normalize($value_8, 'json', $context);
            }
            $data['userGroups'] = $values_8;
        }
        if (null !== $object->getUsers()) {
            $values_9 = array();
            foreach ($object->getUsers() as $value_9) {
