...
class SoftwareNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Rapid7\\InsightVM\\Api\\Model\\Software';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Rapid7\\InsightVM\\Api\\Model\\Software';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Rapid7\InsightVM\Api\Model\Software();
        ...
        if (\array_key_exists('cpe', $data)) {
            $object->setCpe($this->denormalizer->denormalize($data['cpe'], 'Rapid7\\InsightVM\\Api\\Model\\SoftwareCpe', 'json', $context));
        }
