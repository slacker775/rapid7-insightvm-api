...
class GlobalScanNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Rapid7\\InsightVM\\Api\\Model\\GlobalScan';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Rapid7\\InsightVM\\Api\\Model\\GlobalScan';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Rapid7\InsightVM\Api\Model\GlobalScan();
        ...
        if (\array_key_exists('endTime', $data)) {
            $object->setEndTime(\DateTime::createFromFormat('Y-m-d\\TH:i:s.vP', $data['endTime']));
        }
    ...
    public function normalize($object, $format = null, array $context = array())
    {
        ...
        if (null !== $object->getEndTime()) {
            $data['endTime'] = $object->getEndTime()->format('Y-m-d\\TH:i:s.vP');
        }
        ...
        if (null !== $object->getSiteId()) {
            $data['siteId'] = $object->getSiteId();
        }
        if (null !== $object->getSiteName()) {
            $data['siteName'] = $object->getSiteName();
        }
        if (null !== $object->getStartTime()) {
            $data['startTime'] = $object->getStartTime()->format('Y-m-d\\TH:i:s.vP');
        }
